...
const FRONTEND_DEPLOYED_URL = process.env.FRONTEND_DEPLOYED_URL || "http://localhost:27107";
...
module.exports.registerNewUser = async (req, res) => {
    ...
    try {
        ...
        const emailData = {
            email: newUser.email,
            subject: "Welcome to Wagging Tails!",
            body: `
        <html>
...
module.exports.loginFacebook = async (req, res) => {
    ...
    try {
        ...
        const accessToken = jwt.sign(
            { userId: user._id, providerID: user.providerID },
            JWT_SECRET,
            { expiresIn: '1h' }
        );
...
module.exports.loginGoogle = async (req, res) => {
    ...
    const response = decodeJwtResponse(credential);
